...
<head>
    ...
    <title>Обработка ЕГРН выписок</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="bi bi-info-circle"></i> О системе</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="bi bi-question-circle"></i> Помощь</a>
                    </li>
                </ul>
            </div>
        </div>
